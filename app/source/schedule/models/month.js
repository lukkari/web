...
module.exports = Backbone.Model.extend({
  ...
  buildMonth : function () {
    var
      ...
      ld = new Date(d.getFullYear(), d.getMonth() + 1, 0), // last day of the month
    ...
    ld.setDate(ld.getDate() + 6 - (ld.getDay() || 7)); // get last day of the last week

    dur = Math.round((ld.getTime() - d.getTime()) / oneday) + 1; // get difference in days
